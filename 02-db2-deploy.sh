...
DB2_INPUT_PROPS_FILENAME="01-db2-parameters.sh"
DB2_INPUT_PROPS_FILENAME_FULL="${CUR_DIR}/${DB2_INPUT_PROPS_FILENAME}"

##
## Validate input from 01-db2-parameters.sh
##
...
##
## set how many DB Instances are needed
##
...
echo ""
echo "We will be using $DBINSTANCES database instances. Instance uses $db2Cpu cpus and $db2Memory memory."
echo ""
...
##
## Create DB2 project as specified in 01_db2_parameters.sh
##
echo
...
echo
ENTITLEMENTKEY=""
EMAIL="michal.grochowski@ibm.com"
...
# test db2 connection
# 1) oc get pods
# 2) oc rsh pod/c-db2-inst1-db2u-0
# 3) su - db2inst1
